...
Backend là FastAPI + aiosqlite, đọc Gemini JSONL từ `~/.gemini/projects/`.
...
- Gemini Agent CLI tự ghi tool_result (output của Bash/Read) vào JSONL bằng encoding
...
- ⚠️ Mojibake trong tool_result (Bash/Read output được Gemini tự ghi vào JSONL) là
